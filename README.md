...
The default language for the text-to-speech function is `en` (English). Sepcify the language at the second parameter of the command. For example, `python textshot.py eng+fra fr` will use French as the text-to-speech language.
